...
- (https://data.ratp.fr/explore/dataset/positions-geographiques-des-stations-du-reseau-ratp/information/) (geographic position of stations on RATP network), released under the [Open Database License 1.0](http://www.vvlibri.org/fr/licence/odbl/10/fr/legalcode)

- (https://data.ratp.fr/explore/dataset/trafic-annuel-entrant-par-station-du-reseau-ferre-2015/export/) (annual traffic by station on railway network 2015), released under the [Etalab Open License](https://www.etalab.gouv.fr/licence-ouverte-open-licence).

- (https://opendata.stif.info/explore/dataset/traces-du-reseau-ferre-idf/) (layout of the Île-de-France railway network), released under the [Etalab Open License](https://www.etalab.gouv.fr/licence-ouverte-open-licence).

- (https://data.ratp.fr/explore/dataset/indices-et-couleurs-de-lignes-du-reseau-ferre-ratp/) (icons and colours of the RATP railway network lines), released under the [RATP licence](http://data.ratp.fr/page/cgu_ratp).
